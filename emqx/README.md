...
| `metrics.enabled` | (TBD) Enable to get metrics by using emqx_prometheus | false |
| `metrics.gateway` | (TBD) Prometheus PushGateway server url | http://127.0.0.1:9091 |
| `metrics.interval` | (TBD) Push interval. unit: ms | 15000 |
